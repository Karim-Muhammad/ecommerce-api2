...
exports.validateBodyRequest = [
  ...
  validate
    ...
    .custom((subCategories, { req }) => {
      ...
      const allExists = subCategories.every(async (subCategory) => {
        const isExist = await SubCategory.findById(subCategory);
      ...
      const isSubCategoriesBelongsToCategory = subCategories.every(
